...
const Card = (props) => {
    ...
    const {title, image, price, days, columns = '', rows = ''} = props.direction;
    ...
    return (
        <div
            className={"cursor-pointer w-full h-full max-h-[300px] overflow-hidden relative rounded-3xl shadow-[10px_10px_5px_1px_rgba(0,0,0,0.2)]"}
            style={customStyle}
        >
            <div
            ...
            <div className='absolute bottom-0 left-0 z-10 p-5'>
                ...
                <div className="text-white text-lg mb-3 flex gap-5">
                    ...
                    <div className={"flex items-center gap-2"}>
                        ...
                        {t('travel.cities', {postProcess: "interval", count: days})}</div>
                </div>
                <Reserve/>
            </div>
        </div>
...
export const TravelDirections = () => {
    ...
    return (
        <section id='trip'>
            <Container>
                <CustomTitle tag="h2" text="travel.title" className={"text-center mb-14"}/>
